...
YACP allow you to add a countdown to any Wordpress post and page. It's easy to use, open source, and developer friendly
...
1. Countdown example in the header
2. Countdown example in a post
3. YACP admin listing example
