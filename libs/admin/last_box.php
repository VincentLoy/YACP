<div class="tutorial">
    <div class="step">
        ...
        <ol class="tuto-ol">
            ...
            <li>Tick Zero Pad if you want number to be "01" instead of "1"</li>
            <li>Tick Count Up if you want count up if the date is greater than today</li>
    ...
    <div class="step">
        ...
        <ol class="tuto-ol">
            ...
            <li>
                ...
                <a target="_blank"
                   href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=RQCWG6MMSNCC8&item_name=Support+YACP+Plugin+Dev&currency_code=EUR&source=url">
                    buy me a coffee
                </a> <3
            </li>
        </ol>
